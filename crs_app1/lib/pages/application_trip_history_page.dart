...
class ApplicationTripHistoryPage extends StatefulWidget {
  static const String routeName = '/application-Trip-history-page';

  @override
  _ApplicationTripHistoryPageState createState() => _ApplicationTripHistoryPageState();
}

class _ApplicationTripHistoryPageState extends State<ApplicationTripHistoryPage> {
  bool isInit = true;
  @override
